...
import { Download, Ellipsis, FolderPlus, Image as ImageIcon, Info, MessageSquare, Minus, Pencil, Plus, RefreshCw, Settings2, Trash2 } from "lucide-react";
...
export function CanvasNodeHoverToolbar({
    ...
    const imageTools = buildImageToolbarTools(node, { onToggleFreeResize, onMaskEdit, onCrop, onSplit, onUpscale, onAngle, onViewImage, onCopyPrompt: copyImagePrompt, onReversePrompt });
