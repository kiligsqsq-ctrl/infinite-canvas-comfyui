export default {
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", megapixels: "Resolution preset", size: "Size and ratio", seconds: "Seconds", resolution: "Resolution", ratio: "Aspect ratio", duration: "Duration", smart: "Smart", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
    ...
    canvas: {
        ...
        createMenu: {
            fromNode: "Generate from this node", close: "Close", text: "Generate text", textDescription: "Scripts, ad copy, and brand content", image: "Generate image", video: "Generate video", audio: "Generate audio", config: "Configuration node", configDescription: "Model, size, count, and input order", select: "Select a node", uploadAssets: "Upload assets", uploadImage: "Upload image", uploadVideo: "Upload video", uploadAudio: "Upload audio", uploadOnly: "Import only; does not start generation",
        },
        node: {
            node: "Node",
        ...
        configNode: { title: "Generation config", image: "Image", text: "Text", video: "Video", audio: "Audio", prompt: "Prompt", references: "Reference images", videoReferences: "Reference videos", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", preview: "Check", stop: "Stop", generate: "Generate" },
        taskCenter: {
            title: "Generation tasks", clearFinished: "Clear finished", empty: "No generation tasks", untitled: "Generation task", focus: "Focus node", cancel: "Cancel task",
            status: { queued: "Queued", running: "Running", completed: "Completed", failed: "Failed", canceled: "Canceled" },
        },
        missingMedia: {
            title: "Missing media", description: "These media files are not available in this browser's local storage. Select the original files to relink them; nodes and connections will be preserved.", relink: "Relink", none: "No missing media", typeMismatch: "Select a {{kind}} file", relinked: "Media relinked", relinkFailed: "Relink failed",
        },
        generationPreview: {
            title: "Pre-generation check", start: "Confirm and generate", blocked: "Resolve these issues first", ready: "Check complete. Ready to generate",
            model: "Model", channel: "Provider", mode: "Generation type", output: "Result location", workflow: "ComfyUI workflow", outputNode: "Output node {{node}}",
            prompt: "Final prompt", emptyPrompt: "No prompt will be sent", references: "References sent in this order", noReferences: "No reference media will be sent", parameters: "Generation parameters",
            imageLimit: "Images {{used}} / {{limit}}", videoLimit: "Videos {{used}} / {{limit}}", audioLimit: "Audio {{used}} / {{limit}}",
            failed: "Could not read the generation details", workflowMissing: "The mapped ComfyUI workflow is missing from local storage. Import and save it again.", promptMissing: "This task does not have a usable prompt",
            referenceOverflow: "{{kind}} references exceed the workflow limit: {{used}} / {{limit}}", imageKind: "Image", videoKind: "Video", audioKind: "Audio", textReference: "Text {{index}}",
            yes: "Yes", no: "No", writeBack: "The result will be written into the current empty node", createBeside: "A new {{kind}} node will be created to the right",
            parameter: { count: "Count", size: "Size / ratio", quality: "Quality", duration: "Duration", generateAudio: "Generate audio", voice: "Voice", format: "Format", speed: "Speed", reasoning: "Reasoning effort" },
        },
        projectPage: {
        ...
        promptPanel: { video: "Describe the video you want to generate", audio: "Describe the audio you want to generate", image: "Describe the image you want to generate", text: "Describe the text you want to generate", editImage: "Describe how you want to change this image", editText: "Describe how you want to revise this text", expandEditor: "Expand editor", preview: "Pre-generation check", editorTitle: "Edit prompt", stopGeneration: "Stop generation", generate: "Generate", stop: "Stop" },
    ...
    topNav: {
        ...
        updateErrors: {
            ...
            diverged: "The local branch and kiligsqsq-ctrl/infinite-canvas-comfyui main have diverged. Automatic update was stopped to protect local changes.",
            notRepository: "The installation directory is not a Git repository.",
            unavailable: "The local update service is unavailable. Start the canvas with bun run dev and try again.",
            failed: "Update failed. Check the network connection and Git configuration.",
        },
    },
    home: {
    ...
    config: {
        ...
        channels: {
            description: "Local services and cloud APIs can be used together. Assign image, video, text, or audio capabilities per model.",
            add: "Add API provider",
            localQuickTitle: "Quick local connections",
            localQuickDescription: "Choose a service already running on this computer to fill its common endpoint. You can still edit the endpoint and models.",
            addPreset: "Add and configure",
            localTag: "Local",
            apiTag: "API",
        ...
        serviceStatus: {
            title: "Local service status", description: "Check whether local services such as ComfyUI and Ollama are reachable from this computer.", refresh: "Check again", checking: "Checking", online: "Online · {{latency}}ms", offline: "Offline", models: "{{count}} models", unknownError: "Unknown error", empty: "No local services configured",
        },
        preferences: {
            interface: "Interface",
        ...
        channelEditor: {
            ...
            localKeyOptional: "(optional for local services)",
            localKeyPlaceholder: "Usually not required for a local service",
            localNoticeTitle: "Your browser connects directly to this computer's service",
            localNoticeDescription: "Start the local service and allow CORS requests from http://localhost:3000. If the canvas runs on another port, allow that origin instead.",
            comfyCorsDescription: "Start ComfyUI first. If the browser reports a CORS error, launch ComfyUI with --enable-cors-header http://localhost:3000, replacing the origin when the canvas uses another port.",
            testConnection: "Test connection",
            connectionAvailable: "Connected successfully. The service is reachable.",
            connectionAvailableWithModels: "Connected successfully. Found {{count}} models.",
            connectionFailed: "Connection failed. Check the endpoint, service status, and CORS settings.",
            models: "Provider models",
            modelDescription: "{{count}} selected; assign a capability to each model.",
            comfyModelDescription: "{{count}} selected. Use Upload API workflow beside a model to attach your own workflow exported from ComfyUI.",
            selectModels: "Select models",
            workflowReady: "API workflow connected",
            workflow: "Upload API workflow",
        ...
        workflowMapper: {
            title: "{{model}} · ComfyUI workflow mapping", untitled: "Untitled workflow",
            noticeTitle: "Import a ComfyUI API-format workflow JSON", noticeDescription: "The workflow stays in this browser and is not uploaded to GitHub or another server. Once saved, it takes priority over the bundled workflow; generation fills media in canvas order and removes unused media-loader nodes.",
            importFile: "Import workflow JSON", replaceFile: "Replace workflow JSON", fileHint: "Export with ComfyUI's Save (API Format). A regular UI workflow JSON cannot be queued directly.", importedFile: "Imported file", fileSummary: "{{file}} · {{count}} nodes",
            imported: "Detected {{count}} workflow nodes", importFailed: "Failed to read the workflow file", empty: "Import an API-format workflow JSON first", name: "Workflow name",
            prompt: "Prompt input", duration: "Duration input", ratio: "Aspect-ratio input", resolution: "Resolution / megapixel input", seed: "Seed input", imageSlots: "Image reference slots", videoSlots: "Video reference slots", audioSlots: "Audio reference slots", noSlots: "No slots. Add one manually.",
            outputNode: "Result output node", selectNode: "Select a node", clear: "Remove mapping", importFirst: "Import a workflow JSON first", promptRequired: "Select the prompt input", outputRequired: "Select the result output node", missingRequired: "Map these required fields first: {{fields}}", saved: "Workflow mapping saved", saveFailed: "Failed to save workflow mapping",
            miniMaxDetected: "MiniMax-H3 API workflow detected", mappingDetected: "Workflow inputs detected", mappedSummary: "Mapped: {{fields}}", slotSummary: "Reference slots: {{images}} images, {{videos}} videos, {{audios}} audio files", missingSummary: "Still needs manual mapping: {{fields}}", separator: ", ", none: "none",
            checkCompatibility: "Check this ComfyUI", nodesReady: "Compatible: all {{count}} required node types are installed", nodesMissing: "This ComfyUI is missing {{count}} node types", compatibilityFailed: "Could not check ComfyUI nodes", compatibilityConnectionHint: "Check the endpoint, ComfyUI status, and CORS settings", modelFilesNotChecked: "This checks node types only. Confirm model, VAE, CLIP, LoRA, and other files inside ComfyUI separately.",
        },
        modelSelect: {
            missingConfig: "Enter an API endpoint first. Cloud APIs also require an API key.",
            ...
            comfyTitle: "ComfyUI uses workflows instead of a standard model list",
            comfyDescription: "The preset includes MiniMax-H3. Use Upload API workflow beside a model to import your own ComfyUI workflow.",
        ...
        localPresets: {
            comfyui: { name: "ComfyUI · MiniMax-H3", description: "Works with official, source, desktop, and third-party ComfyUI builds; port 8188 is only the common default." },
            ollama: { name: "Ollama", description: "Connect to Ollama's local OpenAI-compatible endpoint and fetch installed models." },
            lmStudio: { name: "LM Studio", description: "Connect to the LM Studio local server and use its loaded OpenAI-compatible models." },
            localOpenAI: { name: "Generic local endpoint", description: "For vLLM, LocalAI, and other locally hosted OpenAI-compatible services." },
        },
        webdav: {
            title: "WebDAV sync",
