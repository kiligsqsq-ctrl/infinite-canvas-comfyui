...
export const toolInputSchemas = {
    ...
    generation_get_status: z.object({ nodeIds: z.array(z.string()).optional(), limit: z.number().optional() }),
...
export const toolDescriptions: Record<ToolName, string> = {
    site_navigate: "跳转网站页面。path 可为 / (首页)、/canvas (我的画布)、/canvas/:id (指定画布)、/assets (我的资产)、/config (配置)。操作画布前若不在画布页，先用本工具打开画布。",
    ...
    generation_get_status: "查询当前画布的生成任务状态；可用 nodeIds 查询指定画布节点。",
