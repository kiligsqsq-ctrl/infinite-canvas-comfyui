...
See [SECURITY.md](https://github.com/kiligsqsq-ctrl/infinite-canvas-comfyui/blob/main/SECURITY.md). Do not post exploit details, private API keys, sensitive screenshots, or real user data in a public issue.
