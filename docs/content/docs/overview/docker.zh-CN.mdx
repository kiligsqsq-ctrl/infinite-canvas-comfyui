...
```bash
git clone git@github.com:kiligsqsq-ctrl/infinite-canvas-comfyui.git
...
services:
  app:
    image: ghcr.io/kiligsqsq-ctrl/infinite-canvas-comfyui:latest
    ports:
      - "3000:3000"
    environment:
...
docker run -d -p 3000:3000 \
  ...
  ghcr.io/kiligsqsq-ctrl/infinite-canvas-comfyui:latest
```
