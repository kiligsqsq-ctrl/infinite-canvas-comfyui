...
```text
请从 https://github.com/kiligsqsq-ctrl/infinite-canvas-comfyui.git 安装 Infinite Canvas Codex 插件。
...
插件会启动本地 Canvas Agent，读取连接地址和 token，然后打开本仓库部署的画布并自动新建、连接画布。
